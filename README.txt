...
a persistence unit "ExamenSimbanaJonnathanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenSimbanaJonnathan\pom.xml":
...
artifact ("ExamenSimbanaJonnathan.war") is already built. You can build
